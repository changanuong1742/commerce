                                    ...
                                    <table class="table table-striped">
                                        ...
                                        foreach ($dataAllProduct as $rowProduct) {
                                            ...
                                            <tr>
                                                ...
                                                <?php   $rowComment = $db->countCommentByProduct($rowProduct['product_id']);
                                                ?>


                                                <td class="py-1">
                                                    <?php echo $rowComment['countCommentByProduct'] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="../admin/commentDetail.php?detailCommentByProduct=<?= $rowProduct['product_id']; ?>"
                                                       class="badge badge-primary p-2">Chi Tiết</a>
                                                    <a href="../action/action.php?deletecommentByProduct=<?= $rowProduct['product_id']; ?>"
